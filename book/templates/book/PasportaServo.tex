...
{% if not ADDRESS_ONLY %}\usepackage[cam, center, width=118mm, height=159mm]{crop}{% endif %}
...
\newfontfamily\Geotica[Scale=3]{Geotica_Three.otf}
...
\begin{document}
  ...
  {% else %}
    ...
    \include{pages/illustration1}
    \include{pages/preface}
    \include{pages/toc}
    \mainmatter
    \include{pages/about}
    \include{pages/how_to_use}
    \include{pages/illustration2}
    \include{pages/address}
    \include{pages/illustration3}
    \include{pages/maps}
    \include{pages/notes}
    \include{pages/illustration4}
  {% endif %}
\end{document}
