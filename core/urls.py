...
from .views import (  # isort:skip
    ...
    RegisterView,
    LoginView,
    AccountRestoreRequestView,
    PasswordResetView,
    PasswordResetConfirmView,
    UsernameRemindView,
    UsernameRemindDoneView,
    AgreementView,
    AgreementRejectView,
    AccountSettingsView,
    PasswordChangeView,
...
urlpatterns = [
    ...
    url(
        _(r"^login/reactivate/$"),
        view=AccountRestoreRequestView.as_view(),
        name="login_restore",
    ),
    ...
    url(
        ...
        include(
            [
                ...
                url(
                    _(r"^reject/$"),
                    view=AgreementRejectView.as_view(),
                    name="agreement_reject",
                ),
            ]
        ),
    ),
    url(
        _(r"^account/settings/$"),
                ...
                url(
                    ...
                    include(
                        [
                            url(
                                r"^$",
                                view=UsernameRemindView.as_view(),
                                name="username_remind",
                            ),
                            url(
                                _(r"^sent/$"),
                                view=UsernameRemindDoneView.as_view(),
                                name="username_remind_done",
                            ),
                        ]
                    ),
                ),
    ...
    url(
        r"^fragment/(?P<fragment_id>\w+)/$",
        HtmlFragmentRetrieveView.as_view(),
        name="get_fragment",
    ),
