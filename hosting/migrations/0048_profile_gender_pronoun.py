...
def populate_genders(app_registry, schema_editor):
    ...
    Gender.objects.bulk_create(
        [
            ...
            Gender(
                id=43, name_en="third gender (Chhakka)", name="tria-genra (Chhakka)"
            ),
            Gender(
                id=44,
                name_en="third gender (Fa'afafine)",
                name="tria-genra (Fa'afafine)",
            ),
            Gender(id=45, name_en="third gender (Hijra)", name="tria-genra (Hijra)"),
            Gender(
                id=46, name_en="third gender (Kathoey)", name="tria-genra (Kathoey)"
            ),
            Gender(
                id=47, name_en="third gender (Khanīth)", name="tria-genra (Khanīth)"
            ),
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_en",
                    models.CharField(
                        max_length=255, unique=True, verbose_name="name (in English)"
                    ),
                ),
                (
                    "name",
        ...
        migrations.RunPython(populate_genders, reverse_code=migrations.RunPython.noop),
        migrations.AddField(
            model_name="profile",
            name="pronoun",
            field=models.CharField(
                blank=True,
                choices=[(None, ""), ("She", "she"), ("He", "he"), ("They", "they")],
                max_length=5,
                verbose_name="personal pronoun",
            ),
        ),
        migrations.AddField(
            model_name="profile",
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True,
                help_text="Short biography. \nProvide here further details about yourself. If you indicated that your gender is non-binary, it will be helpful if you explain more.",
