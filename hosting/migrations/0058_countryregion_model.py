        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "latin_code",
                    models.CharField(
                        max_length=70, verbose_name="Normative code in latin letters"
                    ),
                ),
                (
                    "latin_name",
                    models.CharField(
                        blank=True,
                        max_length=70,
                        verbose_name="Full name in latin letters",
                    ),
                ),
                (
                    "local_code",
                    models.CharField(
                        blank=True,
                        max_length=70,
                        verbose_name="Normative code in local language",
                    ),
                ),
                (
                    "local_name",
                    models.CharField(
                        blank=True,
                        max_length=70,
                        verbose_name="Full name in local language",
                    ),
                ),
                (
                    "esperanto_name",
                    models.CharField(
                        blank=True, max_length=70, verbose_name="Name in Esperanto"
                    ),
                ),
            ],
            options={
