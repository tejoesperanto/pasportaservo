...
class WhereaboutsAdminForm(ModelForm):
    ...
    def clean(self):
        ...
        if (
            whereabouts_type is LocationType.CITY
            ...
            message = _(
                "For a city in {country}, the ISO code of the "
        ...
        if whereabouts_type is LocationType.REGION and not cleaned_data.get("state"):
            # Verifies that a region has both name and code indicated.
            message = _(
                "The 'state / province' field should indicate "
